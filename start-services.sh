...
uv run --locked --project /app/moshi-server worker --config /app/moshi-server/configs/stt.toml &
...
uv run --locked --project /app/moshi-server worker --config /app/moshi-server/configs/tts.toml &
